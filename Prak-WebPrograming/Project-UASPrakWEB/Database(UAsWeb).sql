...
--
-- Host: 127.0.0.1
-- Generation Time: Jul 31, 2023 at 05:22 PM
...
--
-- Dumping data for table `farhanuas`
--

INSERT INTO `farhanuas` (`idvideo`, `judul`, `creator`, `description`, `rating`, `viewer`, `alamatvideo`) VALUES
('IDN129', 'sacad', 'mamang MV', 'asdasdasd', NULL, NULL, 'IDN129');
...
('aan', '$2y$10$rLjXOCF8lp.426onUpw3eOH', '4Pc1JjVjd2rN.zz.vfQk8OE1x4Qgyq', 'user'),
...
('sese', '$2y$10$il90.DjrhELxsy7/dDDoZuK', 'qWdjY9sJWsHok/YP2jSKEgRoP4GYbG', 'admin');
