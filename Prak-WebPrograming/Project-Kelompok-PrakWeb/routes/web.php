...
Route::post('/masuk', [BookController::class,'masuk']);
...
Route::get('/belanja',[BookController::class,'belanja']);

Route::get('/tentang',[BookController::class,'tentang']);

Route::get('/kontak',[BookController::class,'kontak']);
