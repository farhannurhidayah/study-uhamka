      ...
      <div class="carousel-inner">
        <div class="carousel-item active c-item">
          ...
          <div class="carousel-caption top-0 mt-5 ">
            <p class="mt-5 fs-5 text-uppercase" data-aos="fade-up"
     data-aos-duration="2000">Toko Furniture</p>
            <h1 class="display-1 fw-bolder text-capitalizee" data-aos="fade-up"
     data-aos-duration="2500">Temukan Furniture Impianmu Jadikan Rumah Idamanmu</h1>
           <a href="/belanja"> <button class="btn btn-primary px-4 py-2 fs-5 mt-5"  data-aos="fade-up"
     data-aos-duration="3000">Mulai Belanja</button></a>
          </div>
        </div>
