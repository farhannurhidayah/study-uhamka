...
<form action="/registrasi" method="POST" name="pengunjung" id="pengunjung">
    {{csrf_field()}}
<div class="container">
<h1 class="h3 mb-3 fw-normal">Silahkan Daftar Disini</h1>
...
<button class="btn btn-primary w-100 py-2" type="submit"  id="submit" value="Sign in" > Submit</button> 
<p>kembali <a href="/" class="bi bi-arrow-return-left">kembali</a></p>
