...
function ubah($data) {
    ...
    function registrasi($data) {
        ...
        // Fungsi mysql_real_escape_string digunakan untuk mem-bypass karakter spesial dalam query SQL,
        //  sehingga jika attacker mnyertakan karakter seperti ' ! ^ ] ” dan lain sebagainya, 
        // maka fungsi ini tidak akan membaca karakter tersebut.
        ...
        mysqli_query($db,  "INSERT INTO user VALUES ('','$username','$hash')");
        return mysqli_affected_rows($db);
