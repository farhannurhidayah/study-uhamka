  ...
  <nav id="home" class="navbar navbar-expand-lg navbar-dark bg-primary fixed-top">
    <div class="container-fluid ">
     <a class="navbar-brand fs-7 " href="#">
      ...
      <div class="collapse navbar-collapse" id="navbarNavDropdown">
        ...
        <ul class="navbar-nav ">
            <li class="nav-item">
                <a href="/login" class="nav-link"><i class="bi bi-person-circle"> Account</i></a>
            </li>
            <li class="nav-item">
                <a href="/login" class="nav-link"><i class="bi bi-cart3"> Cart</i></a>
            </li>
        </ul>
      </div>
    </div>
